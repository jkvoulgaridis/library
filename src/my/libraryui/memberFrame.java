...
public class memberFrame extends javax.swing.JFrame {
         ...
         if (result_set == null) {
            ...
            if (result_set != null) {
                if (result_set.first()) {
                    ...
                    ID = Integer.parseInt(id_member.getText());
                }
            }
        }catch  (Exception ex ){
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(id_member, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        int id = Integer.parseInt(id_member.getText());
        String first = first_member.getText();
        String last = last_member.getText();
        String street = street_member.getText();
        String number = number_member.getText();
